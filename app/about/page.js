      ...
      <main className={styles.main}>
        <div className={styles.card}>
          ...
          <p>
            ...
            charge a small amount upfront than fill this with ads or sell
            your data. The £9 goes straight toward that: building more ways
            to pull people away from their screens.
          </p>

          <p>
            Because this isn&rsquo;t really about one plan or one week.
            I want to spend my time building things that get people off
            their phones and back into the real world &mdash; drawing,
            writing, making, moving, whatever it is for you. Elsewhere is
            the first step in that, not the whole of it. Every plan someone
            buys helps me keep pushing that forward.
          </p>
