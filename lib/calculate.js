...
// Twelve weeks. This is the horizon the entire app is built around, and it
// matches the twelve weekly milestones in the paid plan later on.
...
// Those daily minutes added up across the twelve weeks, as whole hours.
// reclaimedOverHorizon(53) is 74.
...
// The date twelve weeks from today, written like "18 November".
//
...
//
//   [
//     { percent: 25, perDayLabel: "53 minutes",        proportionLabel: "a quarter",      totalHours: 74,  endDate: "18 November" },
//     { percent: 50, perDayLabel: "1 hour 45 minutes", proportionLabel: "half",           totalHours: 147, endDate: "18 November" },
//     { percent: 75, perDayLabel: "2 hours 38 minutes", proportionLabel: "three quarters", totalHours: 221, endDate: "18 November" },
//   ]
//
// The date is the same on every card -- all three reductions run over the
// same twelve weeks, only the achievement changes. That's on purpose: seeing
// one finish line with three different outcomes is what makes redirecting
// more of your time feel worth it.
