...
// Poem sits in the middle of this list on purpose -- it renders as the
// centre card in GoalPicker's three-column grid, which is where the
// "My personal favourite!" callout (also in GoalPicker.js) points.
export const GOALS = [
  {
    id: "drawing",
    label: "Drawing",
